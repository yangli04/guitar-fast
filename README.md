...
|:---------|:------------|:------|
| Quick Start Guide | Installation, basic usage, all input formats | [HTML](docs/Guitar-Quick-Start.html) / [source](vignettes/Guitar-Quick-Start.Rmd) |
| Benchmark | Performance comparison with original Guitar | [HTML](docs/GuitarFast-Benchmark.html) / [source](vignettes/GuitarFast-Benchmark.Rmd) |
